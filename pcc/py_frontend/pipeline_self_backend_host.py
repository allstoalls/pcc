...
_COMPILER_CACHE_RETENTION_HOST_CODE = (
    ...
    "    from pcc.tools.compiler_cache_retention import sweep_user_caches\n"
    "    sweep = sweep_user_caches(automatic=True, protected_paths=protected)\n"
    "    swept = int(sweep.get('reclaimed_bytes', 0) or 0)\n"
    "    if swept:\n"
    "        sys.stderr.write('pcc user cache sweep: reclaimed=' + str(swept)\n"
    "            + ' bytes_after=' + str(sweep.get('bytes_after', 0)) + '\\n')\n"
