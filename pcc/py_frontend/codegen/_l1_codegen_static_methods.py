...
def _part_1(out):
    ...
    _append_method(out, '_container_store_temp_needs_release', (('self', 'pos', False), ('expr', 'pos', False), ('value_ty', 'pos', False), ('is_cpy', 'pos', False), ('value', 'pos', True)))
    _append_method(out, '_import_from_module_for_local_name', (('self', 'pos', False), ('local_name', 'pos', False)))
    _append_method(out, '_local_slot_decl_type', (('self', 'pos', False), ('ident', 'pos', False), ('ty', 'pos', False)))
    _append_method(out, '_local_slot_ir_type', (('self', 'pos', False), ('ident', 'pos', False), ('ty', 'pos', False)))
...
def _part_5(out):
    ...
    _append_method(out, '_emit_cpy_method_call_src', (('self', 'pos', False), ('mod_val', 'pos', False), ('attr_name', 'pos', False), ('arg_exprs', 'pos', False), ('kwargs', 'pos', True), ('operand_order', 'pos', True), ('receiver_owned', 'pos', True)))
...
def _part_7(out):
    ...
    _append_method(out, '_emit_generic_dyn_method_call_on_value', (('self', 'pos', False), ('recv_obj', 'pos', False), ('attr_name', 'pos', False), ('expr', 'pos', False)))
    _append_method(out, '_emit_shared_container_update', (('self', 'pos', False), ('expr', 'pos', False), ('recv', 'pos', False)))
    _append_method(out, '_emit_finally_entry', (('self', 'pos', False), ('entry', 'pos', False)))
    _append_method(out, '_split_starstar_kwargs_unpack', (('self', 'pos', False), ('arg_exprs', 'pos', False)))
